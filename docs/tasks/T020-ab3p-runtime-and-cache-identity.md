...
Status: Implemented for the typed runtime and cache-identity engineering
scope; the ABREX-on-WSL live smoke remains pending because the available WSL
Python lacks the project dependencies. Assigned implementer: GPT-5.6 Luna.
Milestone: A.
